...
].each do |event_name, image_file_name|
  event = Event.find_by(name: event_name)
  file = File.open Rails.root.join("app/assets/images/#{image_file_name}")
  event.main_image.attach(io: file, filename: image_file_name)
end
